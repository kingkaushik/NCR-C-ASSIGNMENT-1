...
int main()
{
	...
	int annual_time = 1, semi_annual_time = 2, quarter_annual_time = 4, monthly_time = 12, daily_time = 365, no_of_years = 10;
	...
	float monthly_compound_interest = principal * (pow((1 + rate_of_interest / monthly_time), monthly_time*no_of_years) - 1);
	...
	printf("INTEREST COMPOUND MONTHLY =%.2f\n", monthly_compound_interest);
